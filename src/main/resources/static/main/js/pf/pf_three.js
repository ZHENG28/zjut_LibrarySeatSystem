...
function init() {
    ...
    document.getElementById("pf-three").appendChild(container);
    ...
    mtlLoader.load('../main/model/pf/pf_three.mtl', function (mtl) {
        mtl.preload();
        objLoader.setMaterials(mtl);
        objLoader.load('../main/model/pf/pf_three.obj', function (obj) {
            object = obj;
        }, onProgress, onError);
    });
