...
function init() {
    ...
    document.getElementById("pf-one").appendChild(container);
    ...
    mtlLoader.load('../main/model/pf/pf_one.mtl', function (mtl) {
        mtl.preload();
        objLoader.setMaterials(mtl);
        objLoader.load('../main/model/pf/pf_one.obj', function (obj) {
            object = obj;
        }, onProgress, onError);
    });
