...
function init() {
    ...
    document.getElementById("pf-two").appendChild(container);
    ...
    mtlLoader.load('../main/model/pf/pf_two.mtl', function (mtl) {
        mtl.preload();
        objLoader.setMaterials(mtl);
        objLoader.load('../main/model/pf/pf_two.obj', function (obj) {
            object = obj;
        }, onProgress, onError);
    });
