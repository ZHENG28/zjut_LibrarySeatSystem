...
function init() {
    ...
    document.getElementById("pf-five").appendChild(container);
    ...
    mtlLoader.load('../main/model/pf/pf_five.mtl', function (mtl) {
        mtl.preload();
        objLoader.setMaterials(mtl);
        objLoader.load('../main/model/pf/pf_five.obj', function (obj) {
            object = obj;
        }, onProgress, onError);
    });
