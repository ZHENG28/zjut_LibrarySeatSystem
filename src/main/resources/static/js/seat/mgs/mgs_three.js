...
function init() {
    ...
    document.getElementById("mgs-three").appendChild(container);
    ...
    mtlLoader.load('../model/mgs/mgs_three.mtl', function (mtl) {
        mtl.preload();
        objLoader.setMaterials(mtl);
        objLoader.load('../model/mgs/mgs_three.obj', function (obj) {
            object = obj;
        }, onProgress, onError);
    });
